...
public class Seg {
    ...
    private void initColor(final int distance, final int cc) {
        ...
        switch (((d >> 3) ^ cc) % 6) {
        case 0:
            setColor(MazePanel.getRGB(rgbValue, RGB_DEF, RGB_DEF));
            break;
        case 1:
            setColor(MazePanel.getRGB(RGB_DEF, rgbValue, RGB_DEF));
            break;
        case 2:
            setColor(MazePanel.getRGB(RGB_DEF, RGB_DEF, rgbValue));
            break;
        case 3:
            setColor(MazePanel.getRGB(rgbValue, rgbValue, RGB_DEF));
            break;
        case 4:
            setColor(MazePanel.getRGB(RGB_DEF, rgbValue, rgbValue));
            break;
        case 5:
            setColor(MazePanel.getRGB(rgbValue, RGB_DEF, rgbValue));
            break;
        default:
            setColor(MazePanel.getRGB(RGB_DEF, RGB_DEF, RGB_DEF));
            break;
        }
    }
