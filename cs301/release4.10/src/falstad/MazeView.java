...
public class MazeView extends DefaultViewer {
	...
	void redrawTitle(MazePanel gc) {
		...
		builder_box.setFocusable(false);
		drivers_box.setFocusable(false);
		skill_box.setFocusable(false);
	...
	private class ButtonListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			switch(driver) {
			case "Wizard":
				robodrive=new Wizard(controller);
				break;
			case "Wall Follower":
				robodrive=new WallFollower(controller);
				break;
			case "Pledge":
				robodrive=new Pledge(controller);
				break;
			case "Manual":
				robodrive=new ManualDriver(controller);
				break;
			case "Explorer":
				robodrive=new Explorer(controller);
			}
			...
			//controller.setDriver((ManualDriver)robodrive);
